...
exports.handleLogger = exports.handleHelmet = exports.handleCompression = exports.handleBodyRequestParsing = exports.handleCors = void 0;
...
exports.handleLogger = (router) => {
    router.use(logger_1.requestLoggerMiddleware);
};
